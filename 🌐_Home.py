...
st.set_page_config(
    page_title="PureData | Microplastics in Food",
    page_icon="🍴",
    layout="centered"
)
...
# --- Intro Section ---
st.markdown(
    '<div style="font-size: 1.05rem; line-height: 1.7; color: #353535;">'
    ...
    '<li>🥫 <strong>High-risk food categories</li>'
...
st.markdown(
    ...
    '<p>This project is designed to grow as new research emerges and public awareness evolves.</p>'
    '<p style="font-style: italic; margin-top: -0.3rem;">🗺️ Dive into the data. Reflect. Question. Advocate. 🍽️</p>'
    '</div>',
    unsafe_allow_html=True
)